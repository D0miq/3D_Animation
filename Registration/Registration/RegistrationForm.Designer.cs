namespace Registration
{
    partial class RegistrationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // registrationWorker
            // 
            this.registrationWorker.WorkerReportsProgress = true;
            ...
            this.toolTip.SetToolTip(this.maxMappingText, "Max distance of mapped pairs");
            // 
            // label2
            // 
            ...
            this.toolTip.SetToolTip(this.label2, "Max distance of mapped pairs");
            // 
            // groupBox2
            // 
            ...
            this.toolTip.SetToolTip(this.iterationsRadioButton, "Number of iterations has to be equal or greater than 1.");
            ...
            this.toolTip.SetToolTip(this.distanceRadioButton, "Max distance has to be equal or greater than 0 and correspond to the size of regi" +
        "stered objects.");

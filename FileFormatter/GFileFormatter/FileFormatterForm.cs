namespace GFileFormatter
{
    ...
    /// </summary>
    public partial class FileFormatterForm : System.Windows.Forms.Form
    {
        /// <summary>
        /// The logger.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileFormatterForm"/> class.
        /// </summary>
        public FileFormatterForm()
        {
        ...
        private void BackgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                compression.AddFile((string)this.listFiles.CheckedItems[i]);
        ...
        private void BackgroundWorker_Completed(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            this.convertBT.Enabled = true;
            this.listFiles.Enabled = true;
        }
        ...
        private void AddFilesBT_Click(object sender, EventArgs e)
        {
            ...
            {
                this.listFiles.Items.AddRange(openFileDialog.FileNames);
            }
        }
        ...
        /// <summary>
        /// Sets checked state of all files in the <see cref="listFiles"/> on true.
        /// </summary>
        /// <param name="sender">Sender of the event.</param>
        /// <param name="e">Arguments of the event.</param>
        private void CheckBT_Click(object sender, EventArgs e)
        {
            ...
            {
                this.listFiles.SetItemChecked(i, true);
            }
        }
    }
}
